...
class _HomePageState extends State<HomePage>
  ...
  final List<Question> _questions = [
    ...
    Question(
      ...
      answer: false,
      explanation:
          'StatelessWidgets are generally more performant as they don\'t maintain state.',
    ),
    Question(
      title: 'Hot Reload works with changes to the app\'s state.',
      answer: false,
      explanation:
          'Hot Reload works with UI changes but state is preserved, not reset.',
    ),
    Question(
      title: 'Flutter can only build mobile applications.',
      answer: false,
      explanation:
          'Flutter can build for mobile, web, desktop, and embedded devices.',
    ),
    Question(
      title: 'The build() method can return null in a Widget.',
      answer: false,
      explanation:
          'The build() method must always return a Widget, it cannot return null.',
    ),
    Question(
    ...
    Question(
      ...
      answer: false,
      explanation:
          'There are many state management solutions like Provider, Riverpod, Bloc, etc.',
    ),
    Question(
      title: 'The MaterialApp widget is required in every Flutter app.',
      answer: false,
      explanation:
          'You can use CupertinoApp or even build your own app structure.',
    ),
    Question(
      title: 'Flutter compiles to native ARM code for mobile devices.',
      answer: true,
      explanation:
          'Flutter uses Dart\'s native compilation to produce ARM binaries.',
    ),
  ];
